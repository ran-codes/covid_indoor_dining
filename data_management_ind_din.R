...
{ # 2. Data imports ------------------------------------------------------------
  ...
  ## 2.1 COVID outcomes ------------------------------------------------------------
  county_cases<-fread("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_US.csv") %>% as_tibble()
  county_deaths<-fread("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_US.csv") %>% as_tibble()
  ...
  population<-fread("data/co-est2019-annres.csv", header=TRUE) %>% as_tibble()
